...
class DigitalSignatureService
{
    ...
    /**
     * Read certificate from file (.p12/.pfx) using package helpers.
     * Defaults:
     *  - path from env PDF_CERT_PATH
     *  - passphrase from env PDF_CERT_PASS
     *
    ...
    public function readCertificateFromFile(?string $absolutePath = null, ?string $passphrase = null)
    {
        ...
        if (!file_exists($path)) {
            throw new \InvalidArgumentException('Certificate file not found at path: ' . $path);
        }
